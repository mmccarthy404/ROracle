...
/*
   ...
   EXPORT FUNCTION(S)
     ...
     (*) CONNECTION FUNCTIONS
         ...
         rociConBegin    - CONnection transaction BEGIN
   ...
   MODIFIED   (MM/DD/YY)
   mmccarthy   05/28/21 - add rociConBegin()
...
SEXP rociConBegin(SEXP hdlCon)
{
  ...
  {
    /* begin */
    roociBeginCon(&(con->con_rodbiCon));

    RODBI_TRACE("transaction begin");
  }
  else
    RODBI_ERROR(RODBI_ERR_INVALID_CON);
